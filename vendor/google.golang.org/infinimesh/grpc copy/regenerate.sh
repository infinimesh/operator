...
mkdir -p ${WORKDIR}/out/google.golang.org/infinimesh/grpc/balancer/rls/internal/proto/grpc_lookup_v1
mv ${WORKDIR}/out/google.golang.org/infinimesh/grpc/lookup/grpc_lookup_v1/* ${WORKDIR}/out/google.golang.org/infinimesh/grpc/balancer/rls/internal/proto/grpc_lookup_v1
...
rm ${WORKDIR}/out/google.golang.org/infinimesh/grpc/reflection/grpc_testingv3/*.pb.go
...
cp -R ${WORKDIR}/out/google.golang.org/infinimesh/grpc/* .
